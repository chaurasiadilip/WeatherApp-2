...
public abstract class Hilt_UserDetailFragment<BINDING extends ViewDataBinding, VM extends BaseViewModel> extends BaseFragment<BINDING, VM> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((UserDetailFragment_GeneratedInjector) this.generatedComponent()).injectUserDetailFragment(UnsafeCasts.<UserDetailFragment>unsafeCast(this));
    }
  }
